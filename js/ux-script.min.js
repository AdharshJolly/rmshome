        ...
        return (
          ...
          lt(function (o, a, s, l) {
            var u,
              ...
              y = n ? (i || (o ? e : h || r) ? [] : a) : m;
            if ((n && n(m, y, s, l), r))
              for (u = xt(y, d), r(u, [], s, l), c = u.length; c--; )
                (p = u[c]) && (y[d[c]] = !(m[d[c]] = p));
            if (o) {
              if (i || e) {
                if (i) {
    ...
    x.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++) {
          for (1 === e.nodeType && x.cleanData(Ft(e, !1)); e.firstChild; )
  ...
  function load(type, urls, callback, obj, context) {
    ...
    if ((env || getEnv(), urls))
      if (
        ...
        for (i = 0, len = urls.length; len > i; ++i)
          queue[type].push({
            urls: [urls[i]],
      ...
      for (
        ...
        (url = pendingUrls[i]),
          isCSS
            ...
            : ((node = createNode("script", { src: url })), (node.async = !1)),
...
if (!window.ux) {
  ...
  (ux.core.resourcePath = scriptPath.substr(
    0,
    scriptPath.lastIndexOf("/v.") + 9
  )),
    (ux.core.version = ux.core.resourcePath
      .substr(
        scriptPath.lastIndexOf("/v.") + 1,
        scriptPath.lastIndexOf("/v.") + 9
      )
      .replace("/", "")),
    ...
    (ux.features.startup = function (callback) {
      void 0 != window.beforeUX &&
        "function" == typeof window.beforeUX &&
        beforeUX(),
        ...
        ("chrome" == ux.core.browser ||
          "safari" == ux.core.browser ||
          "opera" == ux.core.browser) &&
        ...
        jQuery(
          "#ux-side-nav ul li:first-child, #ux-footer ul li:first-child"
        ).addClass("first-child"),
        jQuery(
          "#ux-side-nav ul li:last-child, #ux-footer ul li:last-child"
        ).addClass("last-child"),
        jQuery(".dol-container .dol-container:first-child").addClass(
          "first-child"
        ),
        jQuery(".dol-container .dol-container:last-child").addClass(
          "last-child"
        ),
        jQuery(".layout-table-content>.layout-2-col:first-child").addClass(
          "first-child"
        ),
        jQuery(".layout-table-content>.layout-2-col:last-child").addClass(
          "last-child"
        ),
        ...
        "msie" == ux.core.browser &&
          jQuery("body").hasClass("ie7") &&
        ...
        document.getElementById("ux-side-nav-container") &&
          ...
          jQuery("#ux-side-nav-toggle").on("click", function (e) {
            e.preventDefault(),
              e.stopPropagation(),
              jQuery("#ux-domain-menu a.selected").length > 0 &&
                jQuery("#ux-domain-menu a.selected")
            ...
            container.is(":visible")
              ? (link.removeClass("active").attr("aria-expanded", !1),
                container.hide().attr("aria-hidden", !0),
    ...
    (ux.features.load = function (request, callback) {
      function testRequest(request, callback) {
        if (request in ux.libraries)
          if (ux.libraries[request].isLoaded)
            ux.libraries[request].hasOwnProperty("deprecated") &&
          ...
          request in ux.functions
            ...
            : console.log(
                "Unsupported items (" +
                  request +
                  ") requested. Check the syntax for a supported library or directly load item using the lazy load script not the ux.load"
              );
      }
        ...
        if (trusted) {
          if (request.hasOwnProperty("styles")) {
            ...
            if ("string" == typeof styles)
              styleChecker(styles) && LazyLoad.css(assetPath(styles, "css"));
            else
              for (var i = 0, r = styles.length; r > i; i++)
                styleChecker(styles[1]) &&
                  LazyLoad.css(assetPath(styles[i], "css"));
          }
          if (request.hasOwnProperty("script")) {
            var afterLazyLoad = function () {
              request.hasOwnProperty("defaultFunction") &&
                request.defaultFunction(),
                "function" == typeof callback && callback(),
                (request.isLoaded = !0);
            };
            request.hasOwnProperty("specialPath")
              ? LazyLoad.js(
                  assetPath(request.script, "js", request.specialPath),
                  afterLazyLoad
                )
      ...
      function executer(request, callback) {
        ux.functions[request].isLoaded ||
          (ux.functions[request].defaultFunction(),
          (ux.functions[request].isLoaded = !0));
      }
      function assetPath(request, type, specialPath) {
        ...
        return (
          (folder +=
            "js" == type
              ? type + ux.core.jsFolderSuffix
              : type + ux.core.cssFolderSuffix),
          specialPath
            ? ux.core.resourcePath +
              "/" +
              folder +
      ...
      if ("string" == typeof request) testRequest(request, callback);
        ...
        if (request instanceof Array)
          for (var i = 0, r = request.length; r > i; i++)
            "string" == typeof request[i]
              ? testRequest(request[i])
              : "object" == typeof request[i] && ux.features.load(request[i]);
    ...
    (ux.features.override = function (request, obj, act) {
      ...
      request in ux.libraries && "defaultSettings" in ux.libraries[request]
        ...
        : request in ux.functions &&
          "defaultSettings" in ux.functions[request] &&
    ...
    (ux.libraries = {
        ...
        defaultFunction: function () {
          function jQDTExpand_FormatDetails(targetDiv) {
            var expandData = targetDiv.html(),
              sOut =
                '<div class="ux-jQDT-row-expanded-content">' +
                expandData +
                "</div>";
            return sOut;
          }
          jQuery(".ux-jQDT-row-expandable").each(function () {
            ...
            trigger.prepend(
              '<img src="' +
                ux.core.resourcePath +
                '/images/icons/add.png" class="ux-jQDT-row-expand-img">'
            ),
              jQuery(this).find(".ux-jQDT-row-expand-content").hide();
          });
          var jQDTExpand_icon_closed =
              ux.core.resourcePath + "/images/icons/add.png",
            jQDTExpand_icon_opened =
              ux.core.resourcePath + "/images/icons/delete.png";
          jQuery("a.ux-jQDT-row-expand-trigger").on("click", function () {
            var thisTr = jQuery(this).closest("tr"),
              ...
              oTable = jQuery(this)
                .closest("table.data-table")
                .dataTable({ bRetrieve: !0 }),
            ...
            return (
              trig_img.src.match(jQDTExpand_icon_opened)
                ...
                : (jQuery(thisTr)
                    ...
                    .each(function () {
                      jQuery(this).find("img.ux-jQDT-row-expand-img")[0].src =
                        jQDTExpand_icon_closed;
                    }),
                  oTable.fnClose(nTr),
                  (trig_img.src = jQDTExpand_icon_opened),
                  oTable.fnOpen(
                    nTr,
                    jQDTExpand_FormatDetails(targetDiv),
                    "ux-jQDT-row-expanded"
                  )),
              !1
            );
          }),
      ...
      jqueryDatePicker: {
        ...
        defaultSettings: {
          ...
          buttonImage:
            ux.core.resourcePath + "/images/icons/calendar_disabled.png",
          buttonImageOnly: !0,
          changeMonth: !0,
          changeYear: !0,
        },
      ...
      formEnhancements: {
        deprecated:
          "This functionality is no longer avaliable please lookup see the documentation about the split of show hide password and character counter functionality",
        isLoaded: !0,
      },
      characterCounter: {
        script: "lazy-jquery.open-ux.character-counter",
        styles: ["lazy-jquery-open-ux-character-counter"],
        isLoaded: !1,
      },
      showHidePassword: {
      ...
      validation: {
        ...
        styles: ["lazy-jquery-validationEngine"],
      ...
      validationRegEx: {
        ...
        defaultSettings: {},
        defaultFunction: function () {
          jQuery.validationEngineLanguage.allRules = jQuery.extend(
          ...
          ux.features.domSaver("a.ux-expandable", "pageExpandables"),
            ux.dom.pageExpandables.each(function () {
              ...
              obj.parent().is("li")
                ...
                : obj.parent().hasClass("ux-closed") ||
                  "DIV" != obj.parent()[0].nodeName ||
              ...
              function checkSibs(obj) {
                openClose(
                  obj
                    .parent("li")
                    .siblings("li")
                    .children(".ux-expandable.expanded")
                ),
                  openClose(obj);
              }
              function openClose(obj) {
                ...
                obj.hasClass(secondClass)
                  ? container.slideUp(function () {
                      obj.removeClass(secondClass).attr("aria-expanded", !1),
                        container.attr("aria-hidden", !0);
                    })
                  : (container.slideDown().attr("aria-hidden", !1),
                    obj.addClass(secondClass).attr("aria-expanded", !0));
              }
              e.preventDefault(), e.stopPropagation();
              var obj = jQuery(this),
                onlyOne = !1;
              obj.parents().is(".ux-only-one") && (onlyOne = !0),
                onlyOne ? checkSibs(obj) : openClose(obj);
            });
        },
        isLoaded: !1,
      },
              ...
              (jQuery("[placeholder]")
                .focus(function () {
                  ...
                  input.val() === input.attr("placeholder") &&
                    ...
                    document.all && input.get(0).createTextRange().select());
                })
                .blur(function () {
                  var input = jQuery(this);
                  "" === input.val()
      ...
      tableExpandables: {
        defaultFunction: function () {
          jQuery("tr.expandable ~ tr.expandable-child").hide(),
            jQuery("tr.expandable .icon").prepend(
              '<a class="table-expandable-icon contracted" href="#"><img src="' +
                ux.core.resourcePath +
                '/images/background-navigation-expandable-right.gif" alt="show rows"></a>'
            ),
            jQuery("tr.expandable .icon .contracted").live(
              "click",
              function () {
                return (
                  jQuery(this)
                    ...
                    .attr(
                      "src",
                      ux.core.resourcePath +
                        "/images/background-navigation-expandable-down.gif"
                    )
                    .attr("alt", "hide rows"),
                  jQuery(this)
                    .parent()
                    .parent()
                    .nextAll(".expandable-child")
                    .show(),
                  !1
                );
              }
              ...
              return (
                jQuery(this)
                  ...
                  .attr(
                    "src",
                    ux.core.resourcePath +
                      "/images/background-navigation-expandable-right.gif"
                  )
                  .attr("alt", "show rows"),
                jQuery(this)
                  .parent()
...
$(document).ready(function () {
  function menuIsActive(child) {
    for (var node = child.parentNode; null !== node; ) {
      if ($(node).hasClass(MENU_ACTIVE)) return !0;
      node = node.parentNode;
    }
    return !1;
  }
  function toggleMainMenu(button) {
    menuList.hasClass(MENU_ACTIVE)
      ? (menuList.removeClass(MENU_ACTIVE), menuToggle.removeClass(MENU_ACTIVE))
      : button &&
        (menuList.addClass(MENU_ACTIVE), menuToggle.addClass(MENU_ACTIVE)),
      menuItems.removeClass(MENU_ACTIVE).removeClass(MENU_INACTIVE);
  }
  var menuToggle = $("#nys-menu-control"),
    menuList = $("#nys-global-nav"),
    menuItems = menuList.children("li"),
    MENU_ACTIVE = "nys-global-active",
    MENU_INACTIVE = "nys-global-inactive";
  menuItems.length || menuToggle.remove(),
    menuList.length &&
      (menuItems.children("a").on("click", function (e) {
        if ($(this).siblings("ul").length) {
          var item = $(this).parent();
          return (
            item.hasClass(MENU_ACTIVE)
              ? menuItems.removeClass(MENU_ACTIVE).removeClass(MENU_INACTIVE)
              : (menuItems.removeClass(MENU_ACTIVE),
                menuItems.addClass(MENU_INACTIVE),
                item.removeClass(MENU_INACTIVE),
      ...
      menuToggle.on("click", function (e) {
        var t = 1;
        return toggleMainMenu(t), e.preventDefault(), e.stopPropagation(), !1;
      }),
      $(document).on("click", function (e) {
        menuIsActive(e.target) || toggleMainMenu();
      }));
});
!(function ($) {
  ux.features.startup();
