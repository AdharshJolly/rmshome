...
(function ($) {
  $.fn.html5lightbox = function (options) {
    ...
    inst.createMarkup = function () {
      ...
      styleCss +=
        ".html5-hide {display:none !important;} #carousel-html5-lightbox .html5-text {" +
        inst.options.titlecss +
        "}";
      styleCss +=
        ...
        "}";
      styleCss +=
        "#carousel-html5-lightbox .html5-error {" + inst.options.errorcss + "}";
      if (
      ...
      if (inst.options.titlestyle == "right") {
        styleCss +=
          "#carousel-html5-lightbox .html5-elem-wrap {width:" +
          inst.options.imagepercentage +
          "%;height:100%;} #carousel-html5-lightbox .html5-elem-data-box {min-height:100%;}";
        styleCss +=
          "@media (max-width: " +
        ...
        styleCss +=
          "#carousel-html5-lightbox .html5-elem-wrap {height:100%;} #carousel-html5-lightbox .html5-elem-data-box {width:" +
      ...
      styleCss +=
        ...
        "}}";
      $("head").append(
        "<style type='text/css' data-creator='carousel-html5-lightbox'>" +
          styleCss +
          "</style>"
      );
      var elemheight = inst.options.elemautoheight ? "auto" : "100%";
      inst.$lightbox = $(
        "<div id='carousel-html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999998;text-align:center;'>" +
          ...
          if ($(".html5-elem-box-previous", inst.$lightbox).length > 0)
            $(".html5-elem-box-previous", inst.$lightbox).css({
              "margin-left":
                String(
                  boxW / 2 -
                    $(".html5-elem-box-previous", inst.$lightbox).width() / 2
                ) + "px",
    ...
    inst.embedHTML5Video = function ($container, src, autoplay, loopvideo) {
      ...
      if (
        ...
        $("video", $container).acHTML5VideoControls(
          inst.options.skinsfolder,
          inst,
...
(function ($) {
  $.fn.acHTML5VideoControls = function (
    skinFolder,
    parentInst,
    videoElem,
    hideControls,
    ...
    AmazingCarousel.prototype = {
      ...
      processLightbox: function () {
        if (this.options.lightboxobject) {
          ...
          this.options.lightboxobject.each(function (index) {
            if ($(this).data("ytplaylist"))
              instance.options.lightboxobject.splice(index, 1);
          });
        }
      },
      preprocess: function (instance) {
        ...
        $("li.amazingcarousel-item", this.container).each(function (index) {
          if ($(this).data("youtubeapikey")) {
            ...
            youtubeplaylistmaxresults = $(this).data(
          ...
          if (data && data.items) {
            ...
            for (var i = 0; i < data.items.length; i++) {
              ...
              if (
                ...
                data.items[i]["snippet"]["thumbnails"]["maxres"]
              )
              ...
              new_item
                .removeAttr("data-youtubeapikey")
                .removeAttr("data-youtubeplaylistid")
                .removeAttr("data-youtubeplaylistmaxresults");
              ...
              if (
                instance.options.lightboxobject &&
                new_item.find("a").hasClass("html5lightbox")
              )
                new_item.find("a").each(function () {
                  instance.options.lightboxobject.push(this);
                  $(this)
                    .off("click")
                    .click(instance.options.lightboxobject.clickHandler);
                });
              $("li.amazingcarousel-item", instance.container)
                .eq(insert_index)
                .after(new_item);
              insert_index++;
            }
      ...
      readTags: function () {
        ...
        if (this.options.circular && this.options.donotcircularforless)
          if (this.elemLength <= this.options.circularlimit)
      ...
      init: function () {
        ...
        if (
          !instance.options.hidecontaineroninit &&
        ...
        if (instance.options.initsocialmedia)
          $("head").append(
            '<link rel="stylesheet" href="' +
              instance.options.jsfolder +
              'icons/css/fontello.css" type="text/css" />'
          );
        ...
        if (
          instance.options.sameheight &&
          instance.options.direction == "horizontal"
        )
        ...
        if ($img.length) {
          ...
          $img.one("load", function () {
            if (
              ...
              $(this).wrap(
                '<div class="amazingcarousel-image-fix-wrapper" style="width:100%;height:100%;overflow:hidden;"></div>'
              );
              var imgW = $(this).width();
              ...
              if (
                imgW > 0 &&
                imgH &&
                imgW / imgH > instance.options.width / instance.options.height
              ) {
                $(this).css({
                  width: "auto",
                  height: "100%",
                ...
                if (instance.options.centerimage)
                  if ($(this).width() > 0) {
                    var ml =
                      ($(this).closest(".amazingcarousel-image").width() -
                        $(this).width()) /
                      2;
                ...
                if (instance.options.centerimage)
                  if ($(this).height() > 0) {
                    var mt =
                      ($(this).closest(".amazingcarousel-image").height() -
                        $(this).height()) /
                      2;
              ...
              $(this).wrap(
                '<div class="amazingcarousel-image-fit-wrapper" style="width:100%;height:100%;overflow:hidden;"></div>'
              );
              $(this).css({
                width: "auto",
                height: "auto",
            ...
            if (
              instance.options.hidecontainerbeforeloaded &&
              instance.loadindex == instance.totalLength &&
              instance.firstLoad
            ) {
      ...
      enableSwipe: function () {
        if (this.options.enabletouchswipe) {
          var preventDefault =
            ACPlatforms.isAndroid &&
            (this.options.swipepreventdefaultonandroid ||
              (ACPlatforms.androidVersion >= 0 &&
                ACPlatforms.androidVersion <= 5))
              ? true
              : false;
          var instance = this;
          $(
      ...
      createPlayVideo: function () {
        ...
        $(".amazingcarousel-image", this.container).each(function () {
          ...
          $("img", $this).each(function () {
            if ($(this).data("video")) {
              ...
              if ($(this).parent().hasClass("html5lightbox")) {
                var type = instance.checkVideoType(
          ...
          if (isVideo || isLightboxVideo) {
            ...
            var $playVideo = $(
              '<div class="amazingcarousel-play-video" style="position:absolute;left:0;top:0;width:100%;height:100%;cursor:pointer;' +
            ...
            if (isVideo)
              $this.on("click", ".amazingcarousel-play-video", function () {
      ...
      embedHTML5Video: function ($container, src, autoPlay) {
        if (
          ...
          ((ACPlatforms.isIE6789() ||
            ACPlatforms.isIE10() ||
            ACPlatforms.isIE11()) &&
            this.options.nativecontrolsonie) ||
          (ACPlatforms.isIPhone() && this.options.nativecontrolsoniphone) ||
          (ACPlatforms.isIPad() && this.options.nativecontrolsonipad) ||
          (ACPlatforms.isAndroid() && this.options.nativecontrolsonandroid)
        )
          this.options.nativehtml5controls = true;
        if (ACPlatforms.isIOS() || ACPlatforms.isAndroid())
          this.options.nativecontrolsonfullscreen = true;
        $container.html(
          "<div class='amazingcarousel-video-container-" +
            this.id +
            "' style='position:relative;display:block;width:100%;height:100%;'><video class='carousel-inline-video' style='width:100%;height:100%;'" +
      ...
      embedFlash: function ($container, w, h, src, wmode, flashVars) {
        if (ACPlatforms.flashInstalled()) {
          ...
          $container.html(
            "<div class='amazingcarousel-video-error' style='display:block;position:absolute;text-align:center;width:100%;height:100%;left:0px;top:0px;'><div>The required Adobe Flash Player plugin is not installed</div><br /><div style='display:block;position:relative;text-align:center;width:112px;height:33px;margin:0px auto;'><a href='http://www.adobe.com/go/getflashplayer'><img src='https://www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player' width='112' height='33'></img></a></div>"
          );
      },
      playYoutubeVideo: function (href, $videoWrapper) {
        if (this.options.previewmode) {
          $videoWrapper.html(
            "<div class='amazingcarousel-video-error' style='display:block;position:absolute;left:0;top:0;width:100%;height:100%;color:#fff;background-color:#333;'>To view YouTube video, publish the carousel then open it in your web browser</div>"
          );
          return;
        } else {
          var src =
      ...
      playVimeoVideo: function (href, $videoWrapper) {
        if (this.options.previewmode) {
          $videoWrapper.html(
            "<div class='amazingcarousel-video-error' style='display:block;position:absolute;left:0;top:0;width:100%;height:100%;color:#fff;background-color:#333;'>To view Vimeo video, publish the carousel then open it in your web browser</div>"
          );
          return;
        } else {
          var src =
            href + (href.indexOf("?") < 0 ? "?" : "&") + "autoplay=1&api=1";
          $videoWrapper.html(
            "<iframe width='100%' height='100%' src='" +
              src +
              "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>"
      ...
      createHoverOverlay: function () {
        ...
        $(".amazingcarousel-image", this.container).each(function () {
          ...
          if (
            $(this).siblings(".amazingcarousel-hover").length > 0 &&
            !(
            ...
            $(this)
              ...
              .hover(
                function () {
                  $(this)
                    .find(".amazingcarousel-hover")
                    .fadeIn(instance.options.hoverdelay);
                },
                function () {
                  $(this)
                    .find(".amazingcarousel-hover")
                    .fadeOut(instance.options.hoverdelay);
                }
              );
            var $img = $("img", $this);
            $(this)
              .siblings(".amazingcarousel-hover")
              .click(function () {
                $img.click();
              });
          } else if (
            instance.options.showhoveroverlay &&
            !(
              instance.options.hidehoveroverlayontouch &&
              "ontouchstart" in window
            ) &&
            (isLightbox || (isLink && instance.options.showhoveroverlayalways))
          ) {
            var $hoverImage = $(
              '<div class="amazingcarousel-hover-effect" style="display:none;position:absolute;left:0;top:0;width:100%;height:100%;cursor:pointer;' +
                "background-image:url('" +
            ...
            if (ACPlatforms.isIE6789())
              $(this)
                ...
                .hover(
                  function () {
                    $(this)
                      .find(".amazingcarousel-flip")
                      .hide()
                      .insertAfter($(this).find(".amazingcarousel-image"))
                      .fadeIn();
                  },
                  function () {
              ...
              $itemcontainer.hover(
                function () {
                  $(this)
                    .find(".amazingcarousel-flip")
                    .hide()
                    .insertAfter($(this).find(".amazingcarousel-flipout"))
                    .fadeIn();
                },
                function () {
                  $(this).find(".amazingcarousel-flip").fadeOut();
      ...
      checkMK: function () {
        if (this.options.versionmark == "AMF" + "ree")
          for (
            var i = 0;
            i < $(".amazingcarousel-image", this.container).length;
            i++
          )
            if (i % 2 == 0) {
              var item = $(".amazingcarousel-image", this.container).eq(i);
              var mklink = $(
                'a[href="' + this.options.watermarklink + '"]',
                item
              );
              if (
                item.text().indexOf(this.options.wmtext) < 0 ||
                mklink.length < 0
              )
                item.append(
                  '<a href="' +
                    this.options.watermarklink +
                    '" target="_blank"><div style="display:block!important;visibility:visible!important;z-index:999;position:absolute;bottom:4px;right:4px;padding:3px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#fff;color:#333;font:12px Arial,sans-serif;">' +
                    this.options.wmtext +
                    "</div></a>"
                );
              else {
      ...
      resizeCarousel: function () {
          ...
          if (this.options.direction == "horizontal") {
            ...
            if (this.options.usescreenquery) {
              ...
              if (conWidth > 0) {
                ...
                $(".amazingcarousel-list-wrapper", this.container).width(
                  conWidth
                );
              }
            } else {
              ...
              if (conWidth > 0) {
                this.visibleItems = this.options.fullwidth
                  ? Math.ceil(conWidth / this.options.width)
        ...
        if (this.options.sameheight && this.options.direction == "horizontal") {
          ...
          if (this.options.fixaspectratio) {
            ...
            var imageHeight =
              (imageWidth * this.options.height) / this.options.width;
        ...
        if (this.options.direction == "horizontal")
          if (this.options.sameheight)
            $("ul.amazingcarousel-list", this.container).css({ width: "auto" });
          else
            $("ul.amazingcarousel-list", this.container).css(
              "width",
              this.itemSize *
          ...
          $("ul.amazingcarousel-list", this.container).css(
            "height",
            this.options.height *
              (this.options.circular ? this.elemTotalCount : this.elemLength) +
              "px"
          );
        var cssProp =
        ...
        if (this.options.direction == "vertical") {
          ...
          $("div.amazingcarousel-list-container", this.container).css({
            height:
              String(
                itemHeight * this.visibleItems +
                  this.options.spacing * (this.visibleItems - 1)
              ) + "px",
          });
        }
              ...
              if (instance.options.continuous)
                if (instance.continuousReset) {
                  ...
                  instance.transitionTiming =
                    instance.options.transitionduration;
                  instance.slideRun(-1);
                } else {
                  $("ul.amazingcarousel-list", instance.container).animate(
                    instance.animProp,
                    instance.transitionTiming,
      ...
      createItemBottomShadow: function () {
        ...
        var shadow =
          "<div class='amazingcarousel-item-bottom-shadow' " +
      ...
      createBottomShadow: function () {
        ...
        var shadow =
          "<div class='amazingcarousel-bottom-shadow' " +
          "style='display:block;position:absolute;left:" +
          l +
          "%;top:" +
      ...
      createItemBackgroundImage: function () {
        if (
          !this.options.showitembackgroundimage ||
          !this.options.itembackgroundimage
        )
          return;
        var l = (100 - this.options.itembackgroundimagewidth) / 2;
        var background =
          "<div class='amazingcarousel-background-image' " +
          "style='display:block;position:absolute;left:" +
          l +
          "%;top:" +
        ...
        if (this.options.arrowstyle == "always") {
          ...
          this.container.hover(
            function () {
              ...
              if (
                instance.options.circular ||
                instance.currentItem <
                  instance.elemLength - instance.visibleItems
              )
      ...
      hideArrows: function () {
        ...
        if (
          !this.options.circular &&
          this.currentItem >= this.elemLength - this.visibleItems
        )
          $nextArrow.hide();
      ...
      createNav: function () {
        ...
        var $bulletWrapper = $(
          "<div class='amazingcarousel-bullet-wrapper'></div>"
        );
        ...
        var len =
          this.elemLength * bulletSize +
          (this.elemLength - 1) * this.options.navspacing;
      ...
      calcCurrentPage: function (cur) {
        ...
        if (instance.options.navmode == "page") {
          ...
          if (cur + instance.visibleItems >= totalItems)
            curPage = Math.ceil(totalItems / instance.visibleItems) - 1;
      ...
      createNavBullet: function (index) {
        ...
        var spacing =
          index == this.elemLength - 1 ? 0 : this.options.navspacing;
        var w = this.options.navwidth;
        var h = this.options.navheight;
        var $bullet = $(
          "<div class='amazingcarousel-bullet-" +
            index +
        ...
        if (this.options.navstyle == "numbering") {
          ...
          if (this.options.navnumberingbground)
            $bullet.css({
          ...
          $.fn["bulletHighlight" + this.id] = $.fn["bulletSelected" + this.id] =
            function () {
              $(this).css({
                ...
                "background-color":
                  instance.options.navnumberingbgcolorhighlight,
              });
            };
        } else {
          $bullet.css({
      ...
      resizeNav: function () {
        ...
        for (i = 0; i < this.elemLength; i++)
          $(".amazingcarousel-bullet-" + i, this.container)[
            "bulletNormal" + this.id
          ];
        $(".amazingcarousel-bullet-" + curPage, this.container)[
          "bulletHighlight" + this.id
        ];
        var bulletSize =
          this.options.navdirection == "vertical"
            ? this.options.navwidth
      ...
      slideRun: function (index, isManual) {
        ...
        var scrollOptions = {
          transitionduration:
            this.options.continuous && isManual
              ? this.options.originaltransitionduration
              : this.options.transitionduration,
          transitioneasing:
            this.options.continuous && isManual
              ? this.options.originaltransitioneasing
              : this.options.transitioneasing,
          scrollmode:
            this.options.continuous && isManual
              ? this.options.originalscrollmode
              : this.options.scrollmode,
          scrollitems:
            this.options.continuous && isManual
              ? this.options.originalscrollitems
        ...
        if (index >= 0) scrollItems = 1;
          ...
          if (scrollOptions.scrollmode == "item")
            if (scrollItems > scrollOptions.scrollitems)
              scrollItems = scrollOptions.scrollitems;
        }
        var nextItem, dir;
        if (index == -2) {
          dir = -1;
        ...
        if (
          ...
          if (
            totalWidth > 0 &&
            $("li.amazingcarousel-item", this.container).length > 0
          )
            animItemSize =
              totalWidth / $("li.amazingcarousel-item", this.container).length;
        ...
        if (this.options.circular)
          if (dir < 0) {
            ...
            nextItem > this.elemLength - scrollItems &&
        ...
        if (
          ...
          var initPos =
            -1 *
            parseInt(
              $("ul.amazingcarousel-list", this.container).css("margin-left")
            );
          ...
          if (scrollOptions.scrollmode == "item")
            if (dir < 0)
              moveWidth = $(
                "li.amazingcarousel-item-" + nextItem,
                this.container
              ).outerWidth(true);
            else
              moveWidth = $(
                "li.amazingcarousel-item-" + this.currentItem,
                this.container
              ).outerWidth(true);
          if (dir < 0) {
        ...
        $("ul.amazingcarousel-list", this.container).animate(
          this.animProp,
          scrollOptions.transitionduration,
    ...
    this.each(function () {
      ...
      if (
        ...
        if ($(this).data("skin") in AMAZINGCAROUSEL_SKIN_OPTIONS)
          this.options = $.extend(
            {},
            AMAZINGCAROUSEL_SKIN_OPTIONS[$(this).data("skin")],
            this.options
          );
      var instance = this;
      $.each($(this).data(), function (key, value) {
      ...
      var defaultOptions = {
        ...
        wstyledefault: "text",
        wtextdefault:
          "106,81,117,101,114,121,32,67,97,114,111,117,115,101,108,32,70,114,101,101,32,86,101,114,115,105,111,110",
        wimagedefault: "",
      ...
      if (
        this.options.hoveroverlayimage.substring(0, 7).toLowerCase() !=
          "http://" &&
        this.options.hoveroverlayimage.substring(0, 8).toLowerCase() !=
          "https://"
      )
        this.options.hoveroverlayimage =
          this.options.skinsfolder + this.options.hoveroverlayimage;
      if (
